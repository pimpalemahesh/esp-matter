...
def generate_markdown_results(results_table, chunk_id=None, data_model_type="Standard"):
...
def update_mr_description_with_results(markdown_content, chunk_id=None, data_model_type="Standard"):
    try:
        gitlab_api = GitLabAPI()
