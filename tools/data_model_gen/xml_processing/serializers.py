    ...
    def to_dict(cmd, attribute_map=None):
        return {
            ...
            "conformance": (
                ...
                and hasattr(safe_get_attr(cmd, "conformance"), "to_dict")
    ...
    def to_dict(event, attribute_map=None):
        return {
            ...
            "conformance": (
                ...
                and hasattr(safe_get_attr(event, "conformance"), "to_dict")
    ...
    def to_dict(feature, attribute_map=None):
        return {
            ...
            "conformance": (
                ...
                and hasattr(safe_get_attr(feature, "conformance"), "to_dict")
            ...
            "attributes": [
                ...
                for attr in sorted(
                    (
                        feature.get_attribute_list()
                        if hasattr(feature, "get_attribute_list")
            ...
            "commands": [
                ...
                for cmd in sorted(
                    (
                        feature.get_command_list()
                        if hasattr(feature, "get_command_list")
            ...
            "events": [
                ...
                for event in sorted(
                    (
                        feature.get_event_list()
                        if hasattr(feature, "get_event_list")
            ...
            "attributes": [
                ...
                for attr in sorted(
                    (
                        ...
                        if hasattr(cluster, "get_attribute_list")
            ...
            "commands": [
                ...
                for cmd in sorted(
                    (
                        ...
                        if hasattr(cluster, "get_command_list")
            ...
            "events": [
                ...
                for event in sorted(
                    (
                        ...
                        if hasattr(cluster, "get_event_list")
            ...
            "features": [
                ...
                for feature in sorted(
                    (
                        ...
                        if hasattr(cluster, "get_feature_list")
    ...
    def to_dict(device):
        result = {
            ...
            "clusters": [
                ...
                for cluster in (
                    device.get_clusters()
                    if hasattr(device, "get_clusters")
