...
class TestAttributeConditions(unittest.TestCase):
    ...
    def test_attribute_existence_check(self):
        ...
        conformance = {"type": "mandatory", "condition": {"attribute": "0x0000"}}
        result = Conformance(conformance)()

        self.assertEqual("esp_matter::attribute::get(cluster, 0x0000) != nullptr", result)
...
class TestCommandConditions(unittest.TestCase):
    ...
    def test_command_existence_check(self):
        ...
        conformance = {
            "type": "mandatory",
            "condition": {"command": "0x00", "flag": "COMMAND_FLAG_ACCEPTED"},
        }
        result = Conformance(conformance)()

        self.assertEqual("esp_matter::command::get(cluster, 0x00, COMMAND_FLAG_ACCEPTED) != nullptr", result)

    def test_command_without_flag(self):
        """Test command condition without explicit flag"""
        conformance = {"type": "mandatory", "condition": {"command": "0x01"}}
...
class TestBooleanOperations(unittest.TestCase):
    ...
    def test_and_two_features(self):
        ...
        self.assertEqual("((feature_map & feature::lighting::get_id()) && (feature_map & feature::dead_front_behavior::get_id()))", result)
    ...
    def test_or_two_features(self):
        ...
        self.assertEqual("((feature_map & feature::hue_saturation::get_id()) || (feature_map & feature::xy::get_id()))", result)
    ...
    def test_complex_nested_and_or_not(self):
        ...
        self.assertEqual("((((feature_map & feature::hs::get_id()) || (feature_map & feature::xy::get_id()))) && (!(feature_map & feature::off_only::get_id())))", result)
