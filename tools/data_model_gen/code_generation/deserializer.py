...
class ClusterDeserializer:
    ...
    def derserialize(self, json_path: str) -> List[Cluster]:
        ...
        try:
            ...
            for cluster_data in cluster_data_list:
                cluster = self._deserialize_single_cluster(cluster_data)
            ...
            raise Exception(f"Error: {json_path} file not found")
        except Exception as e:
            raise Exception(
                f"Error: {str(e)} while deserializing clusters from {json_path}"
            )
    ...
    def _link_feature_attributes(
        ...
        for attr_name in attr_names:
            ...
            if attr:
                ...
                logger.debug(f"Attribute '{attr_name}' not found in cluster attributes")
    ...
    def _link_feature_commands(
        ...
        for cmd_name in cmd_names:
            ...
            if cmd:
                ...
                logger.warning(f"Command '{cmd_name}' not found in cluster commands")
    ...
    def _link_feature_events(
        ...
        for event_name in event_names:
            ...
            if event:
                ...
                logger.warning(f"Event '{event_name}' not found in cluster events")
    ...
    def derserialize(
        ...
        try:
            ...
            for device_data in device_data_list:
                device = self._deserialize_single_device(
                    device_data, cluster_lookup_table
                )
            ...
            raise Exception(
                f"Error: {str(e)} while deserializing devices from {json_path}"
            )
        ...
        for cluster_data in clusters_data:
            ...
            if cluster_obj:
                ...
                cluster.device_mandatory_features = [
                    ...
                    or feature.code in cluster_feature_names
                ]
