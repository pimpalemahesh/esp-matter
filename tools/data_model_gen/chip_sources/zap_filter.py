...
from chip_sources.server_files_config import ATTRIBUTE_PATTERN, COMMAND_PATTERN, EVENT_PATTERN, CLUSTER_ID_PATTERN
...
def generate_zap_filter_list(clusters_base_dir, output_file):
    ...
    try:
        ...
        logger.error(f"Error writing zap_filter_list.json: {str(e)}")
        return False
