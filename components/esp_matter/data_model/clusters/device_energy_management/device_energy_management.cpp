...
{
    return esp_matter::attribute::create(cluster, ESAType::Id, ATTRIBUTE_FLAG_MANAGED_INTERNALLY, esp_matter_enum8(value));
}

attribute_t *create_esa_can_generate(cluster_t *cluster, bool value)
{
    return esp_matter::attribute::create(cluster, ESACanGenerate::Id, ATTRIBUTE_FLAG_MANAGED_INTERNALLY, esp_matter_bool(value));
}

attribute_t *create_esa_state(cluster_t *cluster, uint8_t value)
{
    return esp_matter::attribute::create(cluster, ESAState::Id, ATTRIBUTE_FLAG_MANAGED_INTERNALLY, esp_matter_enum8(value));
}

attribute_t *create_abs_min_power(cluster_t *cluster, int64_t value)
{
    return esp_matter::attribute::create(cluster, AbsMinPower::Id, ATTRIBUTE_FLAG_MANAGED_INTERNALLY, esp_matter_int64(value));
}

attribute_t *create_abs_max_power(cluster_t *cluster, int64_t value)
{
    return esp_matter::attribute::create(cluster, AbsMaxPower::Id, ATTRIBUTE_FLAG_MANAGED_INTERNALLY, esp_matter_int64(value));
}
...
attribute_t *create_opt_out_state(cluster_t *cluster, uint8_t value)
{
    ...
    return esp_matter::attribute::create(cluster, OptOutState::Id, ATTRIBUTE_FLAG_MANAGED_INTERNALLY, esp_matter_enum8(value));
}
...
cluster_t *create(endpoint_t *endpoint, config_t *config, uint8_t flags)
{
    ...
    if (flags & CLUSTER_FLAG_SERVER) {
        ...
        attribute::create_esa_can_generate(cluster, false);
