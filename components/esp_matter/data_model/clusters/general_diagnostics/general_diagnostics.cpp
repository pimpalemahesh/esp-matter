...
using namespace esp_matter::cluster::general_diagnostics::feature;
using namespace esp_matter::cluster::general_diagnostics::attribute;
using namespace esp_matter::cluster::general_diagnostics::command;
using namespace esp_matter::cluster::general_diagnostics::event;
...
{
    return esp_matter::attribute::create(cluster, RebootCount::Id, ATTRIBUTE_FLAG_MANAGED_INTERNALLY | ATTRIBUTE_FLAG_NONVOLATILE, esp_matter_uint16(value));
}

attribute_t *create_up_time(cluster_t *cluster, uint64_t value)
{
    return esp_matter::attribute::create(cluster, UpTime::Id, ATTRIBUTE_FLAG_MANAGED_INTERNALLY, esp_matter_uint64(value));
}

attribute_t *create_total_operational_hours(cluster_t *cluster, uint32_t value)
{
    return esp_matter::attribute::create(cluster, TotalOperationalHours::Id, ATTRIBUTE_FLAG_MANAGED_INTERNALLY | ATTRIBUTE_FLAG_NONVOLATILE, esp_matter_uint32(value));
}

attribute_t *create_boot_reason(cluster_t *cluster, uint8_t value)
{
    return esp_matter::attribute::create(cluster, BootReason::Id, ATTRIBUTE_FLAG_MANAGED_INTERNALLY, esp_matter_enum8(value));
}
...
{
    return esp_matter::attribute::create(cluster, TestEventTriggersEnabled::Id, ATTRIBUTE_FLAG_MANAGED_INTERNALLY, esp_matter_bool(value));
}
