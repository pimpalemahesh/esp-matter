...
using namespace esp_matter::cluster::thread_network_diagnostics::feature;
using namespace esp_matter::cluster::thread_network_diagnostics::attribute;
using namespace esp_matter::cluster::thread_network_diagnostics::command;
using namespace esp_matter::cluster::thread_network_diagnostics::event;
