...
const uint8_t k_max_hardware_version_string_length = 0u;
const uint8_t k_max_software_version_string_length = 0u;
const uint8_t k_max_manufacturing_date_length = 0u;
