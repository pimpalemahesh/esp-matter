...
esp_err_t add(cluster_t *cluster)
{
    ...
    attribute::create_alarms_active(cluster, 0);
    attribute::create_alarms_supported(cluster, 0);
...
esp_err_t add(cluster_t *cluster)
{
    VerifyOrReturnError(cluster, ESP_ERR_INVALID_ARG);
    update_feature_map(cluster, get_id());
    attribute::create_alarms_suppressed(cluster, 0);
...
esp_err_t add(cluster_t *cluster)
{
    ...
    attribute::create_supported_sensitivity_levels(cluster, 0);
...
attribute_t *create_current_sensitivity_level(cluster_t *cluster, uint8_t value)
{
    ...
    return esp_matter::attribute::create(cluster, CurrentSensitivityLevel::Id, ATTRIBUTE_FLAG_WRITABLE | ATTRIBUTE_FLAG_MANAGED_INTERNALLY | ATTRIBUTE_FLAG_NONVOLATILE, esp_matter_uint8(value));
}
...
attribute_t *create_supported_sensitivity_levels(cluster_t *cluster, uint8_t value)
{
    uint32_t feature_map = get_feature_map_value(cluster);
    VerifyOrReturnValue(feature_map & feature::sensitivity_level::get_id(), NULL);
    return esp_matter::attribute::create(cluster, SupportedSensitivityLevels::Id, ATTRIBUTE_FLAG_MANAGED_INTERNALLY, esp_matter_uint8(value));
}

attribute_t *create_default_sensitivity_level(cluster_t *cluster, uint8_t value)
{
    return esp_matter::attribute::create(cluster, DefaultSensitivityLevel::Id, ATTRIBUTE_FLAG_MANAGED_INTERNALLY, esp_matter_uint8(value));
}
...
attribute_t *create_alarms_active(cluster_t *cluster, uint8_t value)
{
    ...
    return esp_matter::attribute::create(cluster, AlarmsActive::Id, ATTRIBUTE_FLAG_MANAGED_INTERNALLY, esp_matter_bitmap8(value));
}
...
attribute_t *create_alarms_suppressed(cluster_t *cluster, uint8_t value)
{
    ...
    return esp_matter::attribute::create(cluster, AlarmsSuppressed::Id, ATTRIBUTE_FLAG_MANAGED_INTERNALLY, esp_matter_bitmap8(value));
}

attribute_t *create_alarms_enabled(cluster_t *cluster, uint8_t value)
{
    return esp_matter::attribute::create(cluster, AlarmsEnabled::Id, ATTRIBUTE_FLAG_MANAGED_INTERNALLY | ATTRIBUTE_FLAG_NONVOLATILE, esp_matter_bitmap8(value));
}
...
attribute_t *create_alarms_supported(cluster_t *cluster, uint8_t value)
{
    uint32_t feature_map = get_feature_map_value(cluster);
    VerifyOrReturnValue(((feature_map & feature::visual::get_id()) || (feature_map & feature::audible::get_id())), NULL);
    return esp_matter::attribute::create(cluster, AlarmsSupported::Id, ATTRIBUTE_FLAG_MANAGED_INTERNALLY, esp_matter_bitmap8(value));
}

attribute_t *create_sensor_fault(cluster_t *cluster, uint8_t value)
{
    return esp_matter::attribute::create(cluster, SensorFault::Id, ATTRIBUTE_FLAG_MANAGED_INTERNALLY, esp_matter_bitmap8(value));
}
