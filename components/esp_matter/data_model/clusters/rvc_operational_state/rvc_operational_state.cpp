...
using namespace esp_matter::cluster::rvc_operational_state::attribute;
using namespace esp_matter::cluster::rvc_operational_state::command;
using namespace esp_matter::cluster::rvc_operational_state::event;
