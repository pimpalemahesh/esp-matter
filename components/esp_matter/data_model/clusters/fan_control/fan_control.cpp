...
using namespace esp_matter::cluster::fan_control::feature;
using namespace esp_matter::cluster::fan_control::attribute;
using namespace esp_matter::cluster::fan_control::command;
