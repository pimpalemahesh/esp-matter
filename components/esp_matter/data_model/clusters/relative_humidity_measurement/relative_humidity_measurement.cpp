...
using namespace esp_matter::cluster::relative_humidity_measurement::attribute;
...
attribute_t *create_min_measured_value(cluster_t *cluster, nullable<uint16_t> value)
{
    ...
    esp_matter::attribute::add_bounds(attribute, esp_matter_nullable_uint16(0), esp_matter_nullable_uint16(9999));
    return attribute;
}
