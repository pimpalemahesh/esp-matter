...
using namespace esp_matter::cluster::localization_configuration::attribute;
...
{
    return esp_matter::attribute::create(cluster, ActiveLocale::Id, ATTRIBUTE_FLAG_WRITABLE | ATTRIBUTE_FLAG_MANAGED_INTERNALLY | ATTRIBUTE_FLAG_NONVOLATILE, esp_matter_char_str(value, length));
}
...
cluster_t *create(endpoint_t *endpoint, config_t *config, uint8_t flags)
{
    ...
    if (flags & CLUSTER_FLAG_SERVER) {
        ...
        attribute::create_active_locale(cluster, NULL, 0);
