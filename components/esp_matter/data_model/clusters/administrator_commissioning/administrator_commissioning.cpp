...
using namespace esp_matter::cluster::administrator_commissioning::feature;
using namespace esp_matter::cluster::administrator_commissioning::attribute;
using namespace esp_matter::cluster::administrator_commissioning::command;
...
{
    return esp_matter::attribute::create(cluster, WindowStatus::Id, ATTRIBUTE_FLAG_MANAGED_INTERNALLY, esp_matter_enum8(value));
}

attribute_t *create_admin_fabric_index(cluster_t *cluster, nullable<uint16_t> value)
{
    return esp_matter::attribute::create(cluster, AdminFabricIndex::Id, ATTRIBUTE_FLAG_MANAGED_INTERNALLY | ATTRIBUTE_FLAG_NULLABLE, esp_matter_nullable_uint16(value));
}

attribute_t *create_admin_vendor_id(cluster_t *cluster, nullable<uint16_t> value)
{
    return esp_matter::attribute::create(cluster, AdminVendorId::Id, ATTRIBUTE_FLAG_MANAGED_INTERNALLY | ATTRIBUTE_FLAG_NULLABLE, esp_matter_nullable_uint16(value));
}
