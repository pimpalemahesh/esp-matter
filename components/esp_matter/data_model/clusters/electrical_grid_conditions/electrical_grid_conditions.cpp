...
using namespace esp_matter::cluster::electrical_grid_conditions::feature;
using namespace esp_matter::cluster::electrical_grid_conditions::attribute;
using namespace esp_matter::cluster::electrical_grid_conditions::event;
