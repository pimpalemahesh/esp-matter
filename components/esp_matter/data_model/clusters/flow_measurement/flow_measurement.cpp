...
using namespace esp_matter::cluster::flow_measurement::attribute;
...
attribute_t *create_min_measured_value(cluster_t *cluster, nullable<uint16_t> value)
{
    ...
    esp_matter::attribute::add_bounds(attribute, esp_matter_nullable_uint16(0), esp_matter_nullable_uint16(65533));
    return attribute;
}
