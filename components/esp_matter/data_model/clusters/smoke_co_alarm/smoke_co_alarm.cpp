...
using namespace esp_matter::cluster::smoke_co_alarm::feature;
using namespace esp_matter::cluster::smoke_co_alarm::attribute;
using namespace esp_matter::cluster::smoke_co_alarm::command;
using namespace esp_matter::cluster::smoke_co_alarm::event;
