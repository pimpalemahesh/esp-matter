...
using namespace esp_matter::cluster::boolean_state::attribute;
using namespace esp_matter::cluster::boolean_state::event;
...
{
    return esp_matter::attribute::create(cluster, StateValue::Id, ATTRIBUTE_FLAG_MANAGED_INTERNALLY, esp_matter_bool(value));
}
...
cluster_t *create(endpoint_t *endpoint, config_t *config, uint8_t flags)
{
    ...
    if (flags & CLUSTER_FLAG_SERVER) {
        ...
        attribute::create_state_value(cluster, false);
