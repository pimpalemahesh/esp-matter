...
{
    return esp_matter::attribute::create(cluster, PowerMode::Id, ATTRIBUTE_FLAG_MANAGED_INTERNALLY, esp_matter_enum8(value));
}

attribute_t *create_number_of_measurement_types(cluster_t *cluster, uint8_t value)
{
    return esp_matter::attribute::create(cluster, NumberOfMeasurementTypes::Id, ATTRIBUTE_FLAG_MANAGED_INTERNALLY, esp_matter_uint8(value));
}
...
{
    return esp_matter::attribute::create(cluster, Voltage::Id, ATTRIBUTE_FLAG_MANAGED_INTERNALLY | ATTRIBUTE_FLAG_NULLABLE, esp_matter_nullable_int64(value));
}

attribute_t *create_active_current(cluster_t *cluster, nullable<int64_t> value)
{
    return esp_matter::attribute::create(cluster, ActiveCurrent::Id, ATTRIBUTE_FLAG_MANAGED_INTERNALLY | ATTRIBUTE_FLAG_NULLABLE, esp_matter_nullable_int64(value));
}

attribute_t *create_reactive_current(cluster_t *cluster, nullable<int64_t> value)
{
    return esp_matter::attribute::create(cluster, ReactiveCurrent::Id, ATTRIBUTE_FLAG_MANAGED_INTERNALLY | ATTRIBUTE_FLAG_NULLABLE, esp_matter_nullable_int64(value));
}

attribute_t *create_apparent_current(cluster_t *cluster, nullable<int64_t> value)
{
    return esp_matter::attribute::create(cluster, ApparentCurrent::Id, ATTRIBUTE_FLAG_MANAGED_INTERNALLY | ATTRIBUTE_FLAG_NULLABLE, esp_matter_nullable_int64(value));
}

attribute_t *create_active_power(cluster_t *cluster, nullable<int64_t> value)
{
    return esp_matter::attribute::create(cluster, ActivePower::Id, ATTRIBUTE_FLAG_MANAGED_INTERNALLY | ATTRIBUTE_FLAG_NULLABLE, esp_matter_nullable_int64(value));
}

attribute_t *create_reactive_power(cluster_t *cluster, nullable<int64_t> value)
{
    return esp_matter::attribute::create(cluster, ReactivePower::Id, ATTRIBUTE_FLAG_MANAGED_INTERNALLY | ATTRIBUTE_FLAG_NULLABLE, esp_matter_nullable_int64(value));
}

attribute_t *create_apparent_power(cluster_t *cluster, nullable<int64_t> value)
{
    return esp_matter::attribute::create(cluster, ApparentPower::Id, ATTRIBUTE_FLAG_MANAGED_INTERNALLY | ATTRIBUTE_FLAG_NULLABLE, esp_matter_nullable_int64(value));
}

attribute_t *create_rms_voltage(cluster_t *cluster, nullable<int64_t> value)
{
    return esp_matter::attribute::create(cluster, RMSVoltage::Id, ATTRIBUTE_FLAG_MANAGED_INTERNALLY | ATTRIBUTE_FLAG_NULLABLE, esp_matter_nullable_int64(value));
}

attribute_t *create_rms_current(cluster_t *cluster, nullable<int64_t> value)
{
    return esp_matter::attribute::create(cluster, RMSCurrent::Id, ATTRIBUTE_FLAG_MANAGED_INTERNALLY | ATTRIBUTE_FLAG_NULLABLE, esp_matter_nullable_int64(value));
}

attribute_t *create_rms_power(cluster_t *cluster, nullable<int64_t> value)
{
    return esp_matter::attribute::create(cluster, RMSPower::Id, ATTRIBUTE_FLAG_MANAGED_INTERNALLY | ATTRIBUTE_FLAG_NULLABLE, esp_matter_nullable_int64(value));
}

attribute_t *create_frequency(cluster_t *cluster, nullable<int64_t> value)
{
    return esp_matter::attribute::create(cluster, Frequency::Id, ATTRIBUTE_FLAG_MANAGED_INTERNALLY | ATTRIBUTE_FLAG_NULLABLE, esp_matter_nullable_int64(value));
}
...
{
    return esp_matter::attribute::create(cluster, PowerFactor::Id, ATTRIBUTE_FLAG_MANAGED_INTERNALLY | ATTRIBUTE_FLAG_NULLABLE, esp_matter_nullable_int64(value));
}

attribute_t *create_neutral_current(cluster_t *cluster, nullable<int64_t> value)
{
    return esp_matter::attribute::create(cluster, NeutralCurrent::Id, ATTRIBUTE_FLAG_MANAGED_INTERNALLY | ATTRIBUTE_FLAG_NULLABLE, esp_matter_nullable_int64(value));
}
...
cluster_t *create(endpoint_t *endpoint, config_t *config, uint8_t flags)
{
    ...
    if (flags & CLUSTER_FLAG_SERVER) {
        ...
        attribute::create_number_of_measurement_types(cluster, 32);
