...
using namespace esp_matter::cluster::rvc_clean_mode::feature;
using namespace esp_matter::cluster::rvc_clean_mode::attribute;
using namespace esp_matter::cluster::rvc_clean_mode::command;
