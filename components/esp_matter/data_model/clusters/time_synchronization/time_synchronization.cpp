...
using namespace esp_matter::cluster::time_synchronization::feature;
using namespace esp_matter::cluster::time_synchronization::attribute;
using namespace esp_matter::cluster::time_synchronization::command;
using namespace esp_matter::cluster::time_synchronization::event;
...
esp_err_t add(cluster_t *cluster)
{
    ...
    attribute::create_local_time(cluster, 0);
    attribute::create_time_zone_database(cluster, 0);
    attribute::create_time_zone_list_max_size(cluster, 0);
    attribute::create_dst_offset_list_max_size(cluster, 1);
...
esp_err_t add(cluster_t *cluster)
{
    VerifyOrReturnError(cluster, ESP_ERR_INVALID_ARG);
    update_feature_map(cluster, get_id());
    attribute::create_default_ntp(cluster, NULL, 0);
    attribute::create_supports_dns_resolve(cluster, false);
...
esp_err_t add(cluster_t *cluster)
{
    VerifyOrReturnError(cluster, ESP_ERR_INVALID_ARG);
    update_feature_map(cluster, get_id());
    attribute::create_ntp_server_available(cluster, false);
...
{
    return esp_matter::attribute::create(cluster, UTCTime::Id, ATTRIBUTE_FLAG_MANAGED_INTERNALLY | ATTRIBUTE_FLAG_NULLABLE, esp_matter_nullable_uint64(value));
}

attribute_t *create_granularity(cluster_t *cluster, uint8_t value)
{
    return esp_matter::attribute::create(cluster, Granularity::Id, ATTRIBUTE_FLAG_MANAGED_INTERNALLY, esp_matter_enum8(value));
}

attribute_t *create_time_source(cluster_t *cluster, uint8_t value)
{
    return esp_matter::attribute::create(cluster, TimeSource::Id, ATTRIBUTE_FLAG_MANAGED_INTERNALLY, esp_matter_enum8(value));
}
...
attribute_t *create_default_ntp(cluster_t *cluster, char *value, uint16_t length)
{
    ...
    return esp_matter::attribute::create(cluster, DefaultNTP::Id, ATTRIBUTE_FLAG_MANAGED_INTERNALLY | ATTRIBUTE_FLAG_NULLABLE | ATTRIBUTE_FLAG_NONVOLATILE, esp_matter_char_str(value, length));
}
...
attribute_t *create_local_time(cluster_t *cluster, nullable<uint64_t> value)
{
    uint32_t feature_map = get_feature_map_value(cluster);
    VerifyOrReturnValue(feature_map & feature::time_zone::get_id(), NULL);
    return esp_matter::attribute::create(cluster, LocalTime::Id, ATTRIBUTE_FLAG_MANAGED_INTERNALLY | ATTRIBUTE_FLAG_NULLABLE, esp_matter_nullable_uint64(value));
}
...
attribute_t *create_time_zone_database(cluster_t *cluster, uint8_t value)
{
    uint32_t feature_map = get_feature_map_value(cluster);
    VerifyOrReturnValue(feature_map & feature::time_zone::get_id(), NULL);
    return esp_matter::attribute::create(cluster, TimeZoneDatabase::Id, ATTRIBUTE_FLAG_MANAGED_INTERNALLY, esp_matter_enum8(value));
}
...
attribute_t *create_ntp_server_available(cluster_t *cluster, bool value)
{
    ...
    return esp_matter::attribute::create(cluster, NTPServerAvailable::Id, ATTRIBUTE_FLAG_MANAGED_INTERNALLY, esp_matter_bool(value));
}
...
attribute_t *create_time_zone_list_max_size(cluster_t *cluster, uint8_t value)
{
    uint32_t feature_map = get_feature_map_value(cluster);
    VerifyOrReturnValue(feature_map & feature::time_zone::get_id(), NULL);
    return esp_matter::attribute::create(cluster, TimeZoneListMaxSize::Id, ATTRIBUTE_FLAG_MANAGED_INTERNALLY, esp_matter_uint8(value));
}
...
attribute_t *create_dst_offset_list_max_size(cluster_t *cluster, uint8_t value)
{
    uint32_t feature_map = get_feature_map_value(cluster);
    VerifyOrReturnValue(feature_map & feature::time_zone::get_id(), NULL);
    return esp_matter::attribute::create(cluster, DSTOffsetListMaxSize::Id, ATTRIBUTE_FLAG_MANAGED_INTERNALLY, esp_matter_uint8(value));
}
...
attribute_t *create_supports_dns_resolve(cluster_t *cluster, bool value)
{
    uint32_t feature_map = get_feature_map_value(cluster);
    VerifyOrReturnValue(feature_map & feature::ntp_client::get_id(), NULL);
    return esp_matter::attribute::create(cluster, SupportsDNSResolve::Id, ATTRIBUTE_FLAG_MANAGED_INTERNALLY, esp_matter_bool(value));
}
