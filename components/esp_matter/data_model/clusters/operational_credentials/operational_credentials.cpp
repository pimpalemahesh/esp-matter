...
using namespace esp_matter::cluster::operational_credentials::attribute;
using namespace esp_matter::cluster::operational_credentials::command;
...
{
    return esp_matter::attribute::create(cluster, SupportedFabrics::Id, ATTRIBUTE_FLAG_MANAGED_INTERNALLY, esp_matter_uint8(value));
}

attribute_t *create_commissioned_fabrics(cluster_t *cluster, uint8_t value)
{
    return esp_matter::attribute::create(cluster, CommissionedFabrics::Id, ATTRIBUTE_FLAG_MANAGED_INTERNALLY | ATTRIBUTE_FLAG_NONVOLATILE, esp_matter_uint8(value));
}
...
{
    return esp_matter::attribute::create(cluster, CurrentFabricIndex::Id, ATTRIBUTE_FLAG_MANAGED_INTERNALLY, esp_matter_uint8(value));
}
