...
using namespace esp_matter::cluster::ethernet_network_diagnostics::feature;
using namespace esp_matter::cluster::ethernet_network_diagnostics::attribute;
using namespace esp_matter::cluster::ethernet_network_diagnostics::command;
...
{
    return esp_matter::attribute::create(cluster, PHYRate::Id, ATTRIBUTE_FLAG_MANAGED_INTERNALLY | ATTRIBUTE_FLAG_NULLABLE, esp_matter_nullable_enum8(value));
}

attribute_t *create_full_duplex(cluster_t *cluster, nullable<bool> value)
{
    return esp_matter::attribute::create(cluster, FullDuplex::Id, ATTRIBUTE_FLAG_MANAGED_INTERNALLY | ATTRIBUTE_FLAG_NULLABLE, esp_matter_nullable_bool(value));
}
...
attribute_t *create_packet_rx_count(cluster_t *cluster, uint64_t value)
{
    ...
    return esp_matter::attribute::create(cluster, PacketRxCount::Id, ATTRIBUTE_FLAG_MANAGED_INTERNALLY, esp_matter_uint64(value));
}
...
attribute_t *create_packet_tx_count(cluster_t *cluster, uint64_t value)
{
    uint32_t feature_map = get_feature_map_value(cluster);
    VerifyOrReturnValue(feature_map & feature::packet_counts::get_id(), NULL);
    return esp_matter::attribute::create(cluster, PacketTxCount::Id, ATTRIBUTE_FLAG_MANAGED_INTERNALLY, esp_matter_uint64(value));
}
...
attribute_t *create_tx_err_count(cluster_t *cluster, uint64_t value)
{
    ...
    return esp_matter::attribute::create(cluster, TxErrCount::Id, ATTRIBUTE_FLAG_MANAGED_INTERNALLY, esp_matter_uint64(value));
}
...
attribute_t *create_collision_count(cluster_t *cluster, uint64_t value)
{
    uint32_t feature_map = get_feature_map_value(cluster);
    VerifyOrReturnValue(feature_map & feature::error_counts::get_id(), NULL);
    return esp_matter::attribute::create(cluster, CollisionCount::Id, ATTRIBUTE_FLAG_MANAGED_INTERNALLY, esp_matter_uint64(value));
}
...
{
    return esp_matter::attribute::create(cluster, CarrierDetect::Id, ATTRIBUTE_FLAG_MANAGED_INTERNALLY | ATTRIBUTE_FLAG_NULLABLE, esp_matter_nullable_bool(value));
}

attribute_t *create_time_since_reset(cluster_t *cluster, uint64_t value)
{
    return esp_matter::attribute::create(cluster, TimeSinceReset::Id, ATTRIBUTE_FLAG_MANAGED_INTERNALLY, esp_matter_uint64(value));
}
