...
using namespace esp_matter::cluster::alarm_base::feature;
using namespace esp_matter::cluster::alarm_base::attribute;
using namespace esp_matter::cluster::alarm_base::command;
using namespace esp_matter::cluster::alarm_base::event;
