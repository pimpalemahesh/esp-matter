...
using namespace esp_matter::cluster::closure_control::feature;
using namespace esp_matter::cluster::closure_control::attribute;
using namespace esp_matter::cluster::closure_control::command;
using namespace esp_matter::cluster::closure_control::event;
