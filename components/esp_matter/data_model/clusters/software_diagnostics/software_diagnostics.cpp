...
{
    return esp_matter::attribute::create(cluster, CurrentHeapFree::Id, ATTRIBUTE_FLAG_MANAGED_INTERNALLY, esp_matter_uint64(value));
}

attribute_t *create_current_heap_used(cluster_t *cluster, uint64_t value)
{
    return esp_matter::attribute::create(cluster, CurrentHeapUsed::Id, ATTRIBUTE_FLAG_MANAGED_INTERNALLY, esp_matter_uint64(value));
}
...
attribute_t *create_current_heap_high_watermark(cluster_t *cluster, uint64_t value)
{
    ...
    return esp_matter::attribute::create(cluster, CurrentHeapHighWatermark::Id, ATTRIBUTE_FLAG_MANAGED_INTERNALLY, esp_matter_uint64(value));
}
