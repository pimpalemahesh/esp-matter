...
using namespace esp_matter::cluster::user_label::attribute;
...
{
    return esp_matter::attribute::create(cluster, LabelList::Id, ATTRIBUTE_FLAG_WRITABLE | ATTRIBUTE_FLAG_MANAGED_INTERNALLY | ATTRIBUTE_FLAG_NONVOLATILE, esp_matter_array(value, length, count));
}
