...
constexpr uint32_t ESP_MATTER_ELECTRICAL_ENERGY_TARIFF_DEVICE_TYPE_ID = 0x0513;
constexpr uint8_t ESP_MATTER_ELECTRICAL_ENERGY_TARIFF_DEVICE_TYPE_VERSION = 1;
