...
endpoint_t *create(node_t *node, config_t *config, uint8_t flags, void *priv_data)
{
    ...
    VerifyOrReturnValue(binding_cluster != nullptr, NULL, ESP_LOGE("camera", "Failed to create binding cluster"));
...
{
    esp_err_t err = add_device_type(endpoint, ESP_MATTER_CAMERA_DEVICE_TYPE_ID, ESP_MATTER_CAMERA_DEVICE_TYPE_VERSION);
    ...
    cluster::camera_av_stream_management::feature::video::add(camera_av_stream_management);
