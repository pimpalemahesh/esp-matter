...
{
    esp_err_t err = add_device_type(endpoint, ESP_MATTER_COOK_SURFACE_DEVICE_TYPE_ID, ESP_MATTER_COOK_SURFACE_DEVICE_TYPE_VERSION);
    ...
    cluster::temperature_control::feature::temperature_level::add(temperature_control, &(config->temperature_control_temperature_level));
