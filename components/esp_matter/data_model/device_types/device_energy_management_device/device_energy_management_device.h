...
constexpr uint32_t ESP_MATTER_DEVICE_ENERGY_MANAGEMENT_DEVICE_TYPE_ID = 0x050D;
constexpr uint8_t ESP_MATTER_DEVICE_ENERGY_MANAGEMENT_DEVICE_TYPE_VERSION = 3;
