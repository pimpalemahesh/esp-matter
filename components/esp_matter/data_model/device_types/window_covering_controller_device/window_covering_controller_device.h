...
constexpr uint32_t ESP_MATTER_WINDOW_COVERING_CONTROLLER_DEVICE_TYPE_ID = 0x0203;
constexpr uint8_t ESP_MATTER_WINDOW_COVERING_CONTROLLER_DEVICE_TYPE_VERSION = 4;
