...
constexpr uint32_t ESP_MATTER_TEMPERATURE_CONTROLLED_CABINET_DEVICE_TYPE_ID = 0x0071;
constexpr uint8_t ESP_MATTER_TEMPERATURE_CONTROLLED_CABINET_DEVICE_TYPE_VERSION = 5;
