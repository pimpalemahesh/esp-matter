...
constexpr uint32_t ESP_MATTER_SECONDARY_NETWORK_INTERFACE_DEVICE_TYPE_ID = 0x0019;
constexpr uint8_t ESP_MATTER_SECONDARY_NETWORK_INTERFACE_DEVICE_TYPE_VERSION = 1;
