...
{
    esp_err_t err = add_device_type(endpoint, ESP_MATTER_SECONDARY_NETWORK_INTERFACE_DEVICE_TYPE_ID, ESP_MATTER_SECONDARY_NETWORK_INTERFACE_DEVICE_TYPE_VERSION);
